...
class DockerBuilder(Builder):
    ...
    def _build_server(self, server, ctx):
        ...
        info_dict["volumes"][1] = "nvflare_svc_persist:/tmp/nvflare"
        ...
        info_dict["shm_size"]= "50g"
        info_dict["deploy"] = {
            "resources": {"limits":{"cpus":"8","memory":"64G"},"reservations": {"cpus":"8","memory":"64G","devices": [{"driver": "nvidia", "count": "1", "capabilities": ["gpu"]}]}}}
    ...
    def _build_client(self, client, ctx):
        ...
        info_dict["volumes"].append("nvflare_svc_persist:/tmp/nvflare")
        for i in range(len(info_dict["command"])):
    ...
    def build(self, project, ctx):
        ...
        with open(env_file_path, "wt") as f:
            ...
            f.write("PYTHON_EXECUTABLE=python\n")
            f.write(f"IMAGE_NAME={self.base_image}\n")
