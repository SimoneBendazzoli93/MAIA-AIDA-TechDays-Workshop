...
- [MAIA-AIDA-TechDays-Workshop](#maia-aida-techdays-workshop)
  ...
  - [Part 1: End-to-End Model Development and Deployment Workflow](#part-1-end-to-end-model-development-and-deployment-workflow)
    ...
    - [1.7 Model Deployment and Inference](#17-model-deployment-and-inference)
        ...
        - [Option 3: MAIA Segmentation Portal](#option-3-maia-segmentation-portal)
          - [Requirements](#requirements-1)
          - [Deploying the Model to the MAIA Segmentation Portal](#deploying-the-model-to-the-maia-segmentation-portal)
          - [3D Slicer Integration](#3d-slicer-integration)
          - [MAIA Segmentation Portal](#maia-segmentation-portal)
          - [Orthanc](#orthanc)
          - [MAIA-QR](#maia-qr)
  ...
  - [Part 3: Federated Learning with NVFlare](#part-3-federated-learning-with-nvflare)
    ...
    - [Start the Clients](#start-the-clients)
      - [Start Clients on HPC Clusters](#start-clients-on-hpc-clusters)
    ...
    - [Tutorial: Spleen Segmentation with Federated Learning](#tutorial-spleen-segmentation-with-federated-learning)
      - [Workflow Overview](#workflow-overview)
        ...
        - [2. Experiment Planning (Main Site)](#2-experiment-planning-main-site)
        - [3. Preprocessing (All Sites)](#3-preprocessing-all-sites)
        - [4. Federated Training](#4-federated-training)
        - [5. Cross-Site Evaluation](#5-cross-site-evaluation)
        - [6. Model Packaging](#6-model-packaging)
